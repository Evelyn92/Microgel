...
add = "./../M33/NR_3.3d";
sample = "E:\lfb research\microgel\dataset\sphere_fitting\andrey_simulated\simulated_dataset\24\FOCTS\NiPMAM\ANDREY_FOCTS1.ply";


ptCloud = pcread(sample);
